...
var require_library = __commonJS({
  "node_modules/@prisma/client/runtime/library.js"(exports, module) {
    ...
    var Do = X((Md, ko) => {
      "use strict";
      var Ru = __require("os"), _o = __require("tty"), pe = Qn(), { env: G } = process, je;
    ...
    var Vo = X((zd, $t) => {
      "use strict";
      var ku = __require("fs"), Bo = __require("path"), Du = __require("os"), Lu = qo(), Nu = Lu.version, Ou = /(?:^|^)\s*(?:export\s+)?([\w.-]+)(?:\s*=\s*?|:\s+?)(\s*'(?:\\'|[^'])*'|\s*"(?:\\"|[^"])*"|\s*`(?:\\`|[^`])*`|[^#\r\n]+)?\s*(?:#.*)?(?:$|$)/mg;
      function Fu(e) {
        let r = {}, t = e.toString();
        t = t.replace(/\r\n?/mg, `
`);
...
`);
    ...
    var xo = _(__require("child_process"));
    var Vn = _(__require("fs/promises"));
    var Nt = _(__require("os"));
...
`);
    ...
    var Il = _(Xn());
    var _l = __require("async_hooks");
    var kl = __require("events");
    var Dl = _(__require("fs"));
    var Tt = _(__require("path"));
    var oe = class e {
      constructor(r, t) {
...
Learn how: https://pris.ly/d/${ca[r]}-build`;
    ...
    var Ea = _(__require("fs"));
    var at = _(__require("path"));
    function gn(e) {
...
${t}`, S(n, true));
    ...
    var Gi = _(__require("os"));
    var Oa = _(__require("path"));
...
var require_client = __commonJS({
  "node_modules/.prisma/client/index.js"(exports2) {
    ...
    exports2.Prisma.AttendeeScalarFieldEnum = {
      id: "id",
      name: "name",
      email: "email",
      createdAt: "createdAt",
    ...
    exports2.Prisma.CheckInScalarFieldEnum = {
      id: "id",
      createdAt: "createdAt",
    ...
    var config2 = {
      "generator": {
        ...
        "output": {
          "value": "C:\\Users\\user\\Downloads\\Node-NLW\\server-node\\node_modules\\@prisma\\client",
          "fromEnvVar": null
        },
        "config": {
          "engineType": "library"
      ...
      "inlineSchemaHash": "466e79987ffe64c47a5a181bb9fdf07dd96a08be832ebcf1b6364661b414a9ad",
      "copyEngine": true
    };
